...
private fun EnquiryDto.toDomain(): Enquiry =
    Enquiry(
        id = id,
        slug = slug,
        name = name,
...
private fun PageContentDto.toDomain(): Page.Content? =
    when (this) {
...
private fun StorageTargetDto.toDomain(): Page.Content.Text.StorageTarget =
    when (this) {
...
private fun SubmittedPageDto.toDomain(): SubmittedPage =
    SubmittedPage(
        content = content.map { it.toDomain() },
        conditions = conditions.map { it.toDomain() },
    )

private fun SubmittedContentDto.toDomain(): SubmittedPage.Content =
    when (this) {
...
private fun ConditionDto.toDomain(): SubmittedPage.Condition =
    when (this) {
...
private fun ThemeDto.toDomain(): Theme =
    Theme(
...
private fun BackgroundDto.toDomain(): Theme.Background =
    when (this) {
...
private fun FontDto.toDomain(): Theme.Font =
    when (this) {
